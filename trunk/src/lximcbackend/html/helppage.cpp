...
int helppage::render_page(const struct pupnp::upnp::request &, std::ostream &out)
{
    out << "<h1>Quick start instructions</h1>"
           ...
           "<li />Stereo and multi-channel (5.1 surround) audio."
           "<li />DVD title playback."
           "<li />Subtitle overlay, support for embedded subtitles and subtitle files."
           "<li />Selection of an audio stream and/or subtitle overlay from the DLNA device.</ul>"
