...
#define SOUT_CFG_PREFIX "sout-lximedia_transcode-"

vlc_module_begin ()
    set_shortname( N_("LXiMediaTranscode"))
    set_description( N_("LXiMedia transcode stream output") )
    set_capability( "sout stream", 0 )
    add_shortcut( "lximedia_transcode" )
