...
public:
                                RootDevice(UPnP *, const QUuid &, const QByteArray &deviceType, bool masterRootDevice, int advertisementExpiration = defaultAdvertisementExpiration);
  virtual                       ~RootDevice();
...
private:
  static const int              defaultAdvertisementExpiration;
