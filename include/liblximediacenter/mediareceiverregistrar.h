...
public:
  ...
  void                          handleAction(const UPnP::HttpRequestInfo &, ActionIsAuthorized &);
  void                          handleAction(const UPnP::HttpRequestInfo &, ActionIsValidated &);
  void                          handleAction(const UPnP::HttpRequestInfo &, ActionRegisterDevice &);
