...
private:
  ...
  _lxi_pure _lxi_internal static QSqlDatabase & database(void);

  _lxi_internal static void     handleError(const ::QSqlQuery &, const QString & = QString::null);

private:
  _lxi_internal                 Database(void);
  _lxi_internal                 ~Database();
};
