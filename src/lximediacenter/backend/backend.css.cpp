...
// Menu
    ...
    " list-style: none;\n"
    "}\n"
    "a.menuitem:link    { color: {_PALETTE_TEXT}; text-decoration: none; }\n"
    "a.menuitem:visited { color: {_PALETTE_TEXT}; text-decoration: none; }\n"
    "a.menuitem:active  { color: {_PALETTE_TEXT}; text-decoration: underline; }\n"
    "a.menuitem:hover   { color: {_PALETTE_TEXT}; text-decoration: underline; }\n"
// Content
    "div.content {\n"
    " display: table-cell;\n"
    "}\n"
