...
// List
    ...
    " background-color: {_PALETTE_BASE};\n"
    "}\n"
    ".detailedlist a:link    { color: {_PALETTE_TEXT}; text-decoration: none; }\n"
    ".detailedlist a:visited { color: {_PALETTE_TEXT}; text-decoration: none; }\n"
    ".detailedlist a:active  { color: {_PALETTE_TEXT}; text-decoration: underline; }\n"
    ".detailedlist a:hover   { color: {_PALETTE_TEXT}; text-decoration: underline; }\n"
    "div.thumbnaillist {\n"
    " display: block;\n"
    "}\n"
