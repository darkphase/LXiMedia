...
int helppage::render_page(const struct pupnp::upnp::request &, std::ostream &out)
{
    out << "<h1>Quick start instructions</h1>"
           "<p>This page will briefly describe the steps to take to install LXiMediaServer.</p>"
           "<h2>What is LXiMediaServer?</h2>"
           "<p>LXiMediaServer can be used to play media files "
           "from a PC over a local network on a DLNA capable device (e.g. "
           "television, game console, media center). LXiMediaServer aims at "
           ...
           "and sub-directories will become visible.</p>"
    ...
    out << "<h1>Troubleshooting</h1>"
           ...
           "<h2>LXiMediaServer is not detected in the network</h2>"
           ...
           "try installing LXiMediaServer on another PC and test if the frontend "
           ...
           "LXiMediaServer). If the frontend applications can't find each other, "
           ...
           "Files\\LXiMediaServer\\lximcbackend.exe” and press “Open”. Next, "
           "press “Ok” and check if the newly added item is enabled and press "
           "“Ok” again.</p>"
           "<h2>Files are not visible from LXiMediaServer</h2>"
           ...
           "accessed by LXiMediaServer, need to be accessible by this user. On "
           ...
           "device.</p>"
           "<h2>Codecs</h2>"
           "<p>LXiMediaServer uses <a href=\"http://videolan.org/\">VLC media player</a>, "
           "therefore there is no need to install a codec pack. Nor will "
           "installing a codec pack harm the functioning of LXiMediaServer. "
           "Unfortunately this also means that custom installed codecs are not "
           "recognized by LXiMediaServer, only the codecs supported by this build "
