...
rootdevice::rootdevice(class platform::messageloop &messageloop, class upnp &upnp, const std::string &uuid, const std::string &devicetype)
...
void rootdevice::write_device_description(device_description &desc)
{
    ...
    desc.set_model("LXiMediaServer", "LXiMediaServer", "http://lximedia.sf.net/", "0.5.0");
